...
import { Copy, Share2, Check, ChevronDown, ChevronUp, Trash2, Package, Plus, X, Camera } from 'lucide-react';
        ...
        {appState === 'NO_ACTIVE_BOX' ? (
          <div className="space-y-6">
            <div className="bg-white rounded-[22px] p-6 shadow-[0_12px_32px_rgba(31,20,70,0.12)] space-y-5">
              ...
              >
                {loading ? 'Creating...' : <><Plus size={20} /> Create Box</>}
              </button>
            </div>
          </div>
        ) : (
              ...
              <form onSubmit={handleAddItem} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex items-end">
                    <button type="button" className="w-full h-12 border border-[#E6E0F0] rounded-[12px] flex items-center justify-center gap-2 text-[#8B849E] active:scale-95">
